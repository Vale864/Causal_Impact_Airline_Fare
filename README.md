...
* **Situation:** The airline industry faced a paradigm shift in 2012 as legacy carriers struggled to compete with Low-Cost Carriers on price. Delta needed a way to segment price-sensitive customers without lowering prices across the board.
...
* **Result:** The analysis confirmed the strategy was highly accretive and competitively effective. Results for the DTW-FLL route:
    * **Revenue Lift:** Estimated a 1.8 Million cumulative revenue increase over the treatment period against the counterfactual, with an average quarterly lift of ~200,494.
